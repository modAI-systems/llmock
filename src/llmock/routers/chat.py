...
# Default mock response when no specific response is configured
DEFAULT_MOCK_RESPONSE = "This is a mock response from llmock."
...
async def create_chat_completion(
    ...
    response_content = DEFAULT_MOCK_RESPONSE
